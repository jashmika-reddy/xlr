...
FullTimeEmployee fullTimeEmployee = new FullTimeEmployee(101,"JASHMIKA","REDDY",6000,2000,"NANDYAL");
		fullTimeEmployee.showDetails();
		fullTimeEmployee.sendMessage();
	
		PartTimeEmployee partTimeEmployee = new PartTimeEmployee(102,"SANA","AFRA",150,80,"HYDERABAD");
